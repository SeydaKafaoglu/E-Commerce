...
namespace E_Commerce.Areas.Admin.Controllers
{
    ...
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var eCommerceContext = _context.Sellers.Where(m => m.IsDeleted == false).Include(s => s.City);
        ...
        public async Task<IActionResult> Create([Bind("SellerId,SellerName,SellerEMail,SellerPassword,ConfirmPassword,SellerPhone,SellerDescription,Banned,IsDeleted,SellerRate,CityId")] E_Commerce.Seller seller)
        {
            SHA256 sHA256;
            byte[] hashedPassword;
            byte[] sellerPassword;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SellerId,SellerName,SellerEMail,SellerPassword,ConfirmPassword,SellerPhone,SellerDescription,Banned,IsDeleted,SellerRate,CityId")] E_Commerce.Seller seller, string OldPassword, string OriginalPassword)
        {

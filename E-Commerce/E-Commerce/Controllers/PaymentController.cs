...
namespace E_Commerce.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public IActionResult CheckOut(string cardname, string cardnumber, byte expmonth, short expyear, string cvv)
        {
            try
            {
                long cardNo = Convert.ToInt64(cardnumber); //sayı olup olmadığına bakma //adres çubuğundan geldiyse burdada kontrol edilmesi lazım
            ...
            //foreach (var chr in cardnumber) //sayı olup olmadığına bakma karakter karakter
            //{
            ...
            try
            {
                short cvvNo = Convert.ToInt16(cvv); //sayı olup olmadığına bakma //adres çubuğundan geldiyse burdada kontrol edilmesi lazım
            ...
            Order order = _context.Orders.Where(o => o.OrderId == Convert.ToInt64(HttpContext.Session.GetString("order"))).Include(o=>o.Customer).First(); //ordere al siparişe göre güncelle
            ...
            {
                //ödeme  kurumuna gönder, onay kodu gönder
                // kod geldiyse {
                //veri tabanındaki order ı kapat 
                ...
                msg.From = new MailAddress("info@ecommerce.com", "E-Commerce");
                ...
                msg.IsBodyHtml = true; //mail içinde html kodlar var mı. kalması 
                ...
                NetworkCredential AccountInfo = new NetworkCredential("info@ecommerce.com", "1234"); //mail login bilgileri
        ...
        public async Task<IActionResult> Create([Bind("OrderId,TimeStamp,OrderPrice,AllDelivered,Cancelled,PaymentComplete,PaymentMethodId,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("OrderId,TimeStamp,OrderPrice,AllDelivered,Cancelled,PaymentComplete,PaymentMethodId,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
